...
public class PositionGetController {
    private final PositionService positionService;

    @ApiOperation(value = "Get a list of Positions created in the system", response = PositionsResponse.class)
    @ApiResponses(value = {
    ...
    public ResponseEntity<PositionsResponse> getPositions() {
        return ok(new PositionsResponse(positionService.getPositions()));
    }
}
